...
router.get('/developer', (req, res, next) => {
  ...
  var data = {
    ...
    nakamuraName: '中村 航生',
<<<<<<< HEAD
    nakamuraText: '山梨県出身。2021年4月に株式会社クオーレに入社。最近PCを新調した。そこそこ高スペックなのに原神しかしていない。マジック：ザ・ギャザリング溺愛者。ボードゲームも好きだが最近プレイできていないことが悩み。',
        satoName: '佐藤 翔大',
=======
    nakamuraText: '日本出身。2021年4月に株式会社クオーレに入社。プログラム歴3ヶ月（2021年6月現在）。最近PCを新調した。そこそこ高スペックなのに原神しかしていない。マジック：ザ・ギャザリング溺愛者。ボードゲームも好きだが最近プレイできていないことが悩み。',
    satoName: '佐藤 翔大',
>>>>>>> ad28375e85e41b27b778ea6d8c2c4c311b5671f6
